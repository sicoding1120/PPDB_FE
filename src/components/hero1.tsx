  ...
  return (
    <div className=' flex w-full h-[95vh] bg-hero2 justify-center items-center overflow-hidden relative px-4'>
      ...
      <div className='flex flex-col space-y-4 items-center mt-36 w-full max-w-4xl text-center'>
        ...
        <div className='px-2'>
          <p
            className={`text-3xl sm:text-4xl md:text-5xl font-bold text-black  ${poppins.className}`}
          >
            <span className='text-black'>MyPPDB:</span> Karya
            Hebat <br />
            dari Santri Hebat!
          </p>
        </div>
        ...
        >
          <span className='font-semibold'>MYPPDB</span> adalah
          aplikasi web dan mobile buatan siswa SMK Madinatul Quran yang
          mempermudah proses PPDB online secara cepat, mudah, dan efisien
        </p>
        ...
        <div className='flex flex-col items-center justify-center space-y-3'>
          ...
          <div className='flex flex-wrap gap-4 justify-center'>
            <Button
              variant='custom1'
              className='font-sans text-[12px] px-6'
              size='lg'
            >
              <Image
            ...
            <Button
              variant='custom1'
              className='font-sans text-[12px] px-5'
              size='lg'
            >
              <Image
